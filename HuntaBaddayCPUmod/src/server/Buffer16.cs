...
namespace HuntaBaddayCPUmod {
    public class Buffer16 : LogicComponent {
        ...
        protected override byte[] SerializeCustomData(){
            ...
            data[0x20000] = (byte)(ptr1>>8);
            data[0x20001] = (byte)(ptr1&0xff);
            
            data[0x20002] = (byte)(ptr2>>8);
            data[0x20003] = (byte)(ptr2&0xff);
        ...
        protected override void DeserializeData(byte[] data){
            ...
            if(length == (0x20000 + 2 + 2)){
                ...
                ptr1 = (ushort)((customdata[0x20000]<<8) | (customdata[0x20001]));
                ptr2 = (ushort)((customdata[0x20002]<<8) | (customdata[0x20003]));
            }
            return;
        }
